...
DEFINE_GUIDSTRUCT("452da6d7-a42b-4906-a6c3-8162e72d383d",
                  PROPSETID_VIDCAP_CUSTOM_CAMERACONTROL_MFT0);
#define PROPSETID_VIDCAP_CUSTOM_CAMERACONTROL_MFT0                             \
  DEFINE_GUIDNAMED(PROPSETID_VIDCAP_CUSTOM_CAMERACONTROL_MFT0)
...
} KSPROPERTY_CUSTOM_CAMERACONTROL_MFT0_VIDEOSTABILIZATION_S,
    *PKSPROPERTY_CUSTOM_CAMERACONTROL_MFT0_VIDEOSTABILIZATION_S;
...
DEFINE_GUIDSTRUCT("05DC8943-B9FB-4201-808F-6E91451C4760",
                  PROPSETID_VIDCAP_CUSTOMCONTROL);
#define PROPSETID_VIDCAP_CUSTOMCONTROL                                         \
  DEFINE_GUIDNAMED(PROPSETID_VIDCAP_CUSTOMCONTROL)

enum { KSPROPERTY_CUSTOMCONTROL_DUMMY };
...
DEFINE_GUIDSTRUCT("570615F9-D924-42AC-B967-BE7B0E489965",
                  PROPSETID_SENSOR_CUSTOMCONTROL);
#define PROPSETID_SENSOR_CUSTOMCONTROL                                         \
  DEFINE_GUIDNAMED(PROPSETID_SENSOR_CUSTOMCONTROL)

enum { KSPROPERTY_SENSOR_PIN_CUSTOM_CONTROL_ULONG = 0 };
